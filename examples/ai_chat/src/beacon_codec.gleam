...
pub fn decode_event(_name: String, _handler_id: String, data: String, _target_path: String) -> Result(ai_chat.Msg, String) {
...
fn decode_msg(json_str: String) -> Result(ai_chat.Msg, String) {
  ...
  case json.parse(json_str, tag_decoder) {
    ...
    "SendPrompt" -> {
      ...
      case json.parse(json_str, msg_decoder) {
        Ok(msg) -> Ok(msg)
        Error(_) -> Error("Generated Beacon message payload did not match tag SendPrompt")
      }
    }
    "CharDelta" -> {
      let msg_decoder = {
      ...
      case json.parse(json_str, msg_decoder) {
        Ok(msg) -> Ok(msg)
        Error(_) -> Error("Generated Beacon message payload did not match tag CharDelta")
      }
    }
    "StreamDone" -> {
      let msg_decoder = {
      ...
      case json.parse(json_str, msg_decoder) {
        Ok(msg) -> Ok(msg)
        Error(_) -> Error("Generated Beacon message payload did not match tag StreamDone")
      }
    }
    "StreamError" -> {
      let msg_decoder = {
      ...
      case json.parse(json_str, msg_decoder) {
        Ok(msg) -> Ok(msg)
        Error(_) -> Error("Generated Beacon message payload did not match tag StreamError")
      }
    }
