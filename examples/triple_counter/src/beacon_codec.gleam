...
pub fn encode_model(
  state: #(triple_counter.Model, triple_counter.Local, Nil),
) -> String {
  let model = state.0
  let local = state.1
  json.object([
...
pub fn decode_model(
  json_str: String,
) -> Result(#(triple_counter.Model, triple_counter.Local, Nil), String) {
  let state_decoder = {
    ...
    decode.success(#(
      triple_counter.Model(my_count: my_count, shared_count: shared_count),
      triple_counter.Local(local_count: local_count),
      Nil,
    ))
  }
...
pub fn decode_event(
  ...
  data: String,
  _target_path: String,
) -> Result(triple_counter.Msg, String) {
      ...
      case tag {
        "SharedIncrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag SharedIncrement",
              )
          }
        }
        "SharedDecrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag SharedDecrement",
              )
          }
        }
        "SharedUpdated" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag SharedUpdated",
              )
          }
        }
        "SetSharedCount" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag SetSharedCount",
              )
          }
        }
        "MyIncrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag MyIncrement",
              )
          }
        }
        "MyDecrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag MyDecrement",
              )
          }
        }
        "LocalIncrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag LocalIncrement",
              )
          }
        }
        "LocalDecrement" -> {
          ...
          case json.parse(json_str, msg_decoder) {
            ...
            Error(_) ->
              Error(
                "Generated Beacon message payload did not match tag LocalDecrement",
              )
          }
        }
